...
void xsum_small_init (xsum_small_accumulator *__restrict sacc)
{ 
# if USE_MEMSET_SMALL
...
int xsum_carry_propagate (xsum_small_accumulator *__restrict sacc)
{
...
void xsum_small_display (xsum_small_accumulator *__restrict sacc)
{
  int i, dots;
...
int xsum_small_chunks_used (xsum_small_accumulator *__restrict sacc)
{
  int i, c;
  c = 0;
...
void xsum_small_add_inf_nan (xsum_small_accumulator *__restrict sacc,
                             xsum_int ivalue)
{ 
  xsum_int mantissa;
  union fpunion u;
...
static inline void xsum_add1_no_carry (xsum_small_accumulator *__restrict sacc,
                                       xsum_flt value)
{ 
  union fpunion u;
  xsum_int ivalue;
...
void xsum_small_add1 (xsum_small_accumulator *__restrict sacc, xsum_flt value)
{ 
...
static inline
#endif
void xsum_addv_no_carry (xsum_small_accumulator *__restrict sacc,
                         const xsum_flt *__restrict vec,
                         xsum_length n)
{ 
# if OPT_SMALL_SUM
  { xsum_flt f;
...
void xsum_small_addv (xsum_small_accumulator *__restrict sacc,
                      const xsum_flt *__restrict vec,
                      xsum_length n)
{ xsum_length m;
...
static inline
#endif
void xsum_add_sqnorm_no_carry (xsum_small_accumulator *__restrict sacc,
                             const xsum_flt *__restrict vec,
                             xsum_length n)
{ 
# if OPT_SMALL_SQNORM
...
void xsum_small_add_sqnorm (xsum_small_accumulator *__restrict sacc,
                            const xsum_flt *__restrict vec,
                            xsum_length n)
{ xsum_length m;
...
static inline
#endif
void xsum_add_dot_no_carry (xsum_small_accumulator *__restrict sacc,
...
void xsum_small_add_dot (xsum_small_accumulator *__restrict sacc,
                         const xsum_flt *vec1, const xsum_flt *vec2, 
                         xsum_length n)
{ xsum_length m;
...
xsum_flt xsum_small_round (xsum_small_accumulator *__restrict sacc)
{ 
  xsum_int ivalue;
  xsum_schunk lower;
  union fpunion u;
...
void xsum_large_init (xsum_large_accumulator *__restrict lacc)
{ 
# if USE_MEMSET_LARGE
  {
...
static inline 
#endif
void xsum_add_lchunk_to_small (xsum_large_accumulator *__restrict lacc,
                               xsum_expint ix)
{
  xsum_expint exp, low_exp, high_exp;
...
static inline 
#endif
void xsum_large_add_value_inf_nan (xsum_large_accumulator *__restrict lacc,
...
void xsum_large_addv (xsum_large_accumulator *__restrict lacc,
                      const xsum_flt *__restrict vec,
                      xsum_length n)
{
...
void xsum_large_add_sqnorm (xsum_large_accumulator *__restrict lacc,
                            const xsum_flt *__restrict vec,
                            xsum_length n)
{ 
...
void xsum_large_add_dot (xsum_large_accumulator *__restrict lacc,
                         const xsum_flt *vec1, 
                         const xsum_flt *vec2, 
                         xsum_length n)
{
...
xsum_flt xsum_large_round (xsum_large_accumulator *__restrict lacc)
{
...
void xsum_large_display (xsum_large_accumulator *__restrict lacc)
{
  int i, dots;
...
int xsum_large_chunks_used (xsum_large_accumulator *__restrict lacc)
{
  int i, c;
  c = 0;
...
xsum_flt xsum_sum_double (const xsum_flt *__restrict vec,
                          xsum_length n)
{ double s;
  xsum_length j;
  s = 0.0;
...
xsum_flt xsum_sum_float128 (const xsum_flt *__restrict vec,
                            xsum_length n)
{ __float128 s;
  xsum_length j;
  s = 0.0;
...
xsum_flt xsum_sum_double_not_ordered (const xsum_flt *__restrict vec,
                                      xsum_length n)
{ double s1, s2;
  xsum_length j;
  s1 = s2 = 0.0;
...
xsum_flt xsum_sum_kahan (const xsum_flt *__restrict vec,
                         xsum_length n)
{ double s, t, c, y;
  xsum_length j;
  s = 0.0;
...
xsum_flt xsum_sqnorm_double (const xsum_flt *__restrict vec,
                             xsum_length n)
{ double s;
  xsum_length j;
...
xsum_flt xsum_sqnorm_double_not_ordered (const xsum_flt *__restrict vec,
                                         xsum_length n)
{ double s1, s2, a, b;
  xsum_length j;
  s1 = s2 = 0.0;
